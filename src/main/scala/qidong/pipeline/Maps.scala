...
object MapFst {
  ...
  implicit def m[MT <: HList, F[_]: Functor, I, O, I0] =
    new MapFst[M[F, I, O] :: MT, I0, I] {
      ...
      override def apply(m: M[F, I, O] :: MT, f: I0 => I): Out = m.head.mapfst(f) :: m.tail
    }
  ...
  implicit def ms[M1, M2, MT <: HList, ML <: HList, I0, I](implicit mapFst: MapFst[M1, I0, I]) =
    new MapFst[Ms[M1, M2, MT] :: ML, I0, I] {
      ...
      override def apply(mm: Ms[M1, M2, MT] :: ML, f: I0 => I): Out = mm.head.mapfst(f) :: mm.tail
    }
...
object MapSnd {
  ...
  implicit def m[F[_]: Functor, I, O, O2] =
    new MapSnd[M[F, I, O] :: HNil, O, O2] {
      ...
      override def apply(mm: M[F, I, O] :: HNil, f: O => O2): Out = mm.head.mapsnd(f) :: HNil
    }
  ...
  implicit def ms[M1, M2, MT <: HList, O, O2, H, T <: HList, Out0 <: HList](
    ...
    new MapSnd[Ms[M1, M2, MT] :: HNil, O, O2] {
      ...
      override def apply(mm: Ms[M1, M2, MT] :: HNil, f: O => O2) = mm.head.mapsnd(f) :: HNil
    }
  ...
  implicit def coinductively[MM, MT <: HList, O, O2, Out0 <: HList](
    ...
    new MapSnd[MM :: MT, O, O2] {
      ...
      override def apply(mm: MM :: MT, f: O => O2): Out = mm.head :: mapSnd(mm.tail, f)
    }
}
